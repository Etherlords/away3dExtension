package away3d.animators
{
	...
	public class ParticleAnimator extends AnimatorBase implements IAnimator
	{
		...
		protected var _animationParticleStates:Vector.<ParticleStateBase> = new Vector.<ParticleStateBase>;
		protected var _animatorParticleStates:Vector.<ParticleStateBase> = new Vector.<ParticleStateBase>;
		protected var _timeParticleStates:Vector.<ParticleStateBase> = new Vector.<ParticleStateBase>;
		protected var _totalLenOfOneVertex:uint = 0;
		protected var _animatorSubGeometries:Dictionary = new Dictionary(true);
